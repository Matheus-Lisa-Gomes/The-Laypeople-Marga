...
const TOPICS_DATA = [
  {
    ...
    englishTitle: "The Four Noble Truths",
    ...
    keyPaliTerms: [
      ...
      { term: "Taṇhā", meaning: "Thirst, feverish craving (kāma-taṇhā, bhava-taṇhā, vibhava-taṇhā)" }
    ],
    ...
    householdApplication: [
      ...
      },
      {
        ...
        detail: "The 8 factors divide into Sīla (Ethical Integrity: Right Speech, Action, Livelihood), Samādhi (Mental Cultivation: Right Effort, Mindfulness, Stillness), and Paññā (Discernment: Right View, Intention). A householder practices this across workplace negotiations, dinner table conversations, and evening sitting."
      }
    ],
  ...
  },
  {
    ...
    englishTitle: "Dependent Arising",
    ...
    householdApplication: [
      ...
      },
      {
        ...
        detail: "Every addiction (phone scrolling, comfort eating, compulsive shopping) follows the 12 links: Trigger → Contact → Pleasant Feeling → Craving → Grasping. Interrupt the chain at the trigger level."
      }
    ],
    contemplativeInquiry: [
  ...
  },
  {
    ...
    number: "03",
    paliTitle: "Bhāvanā",
    englishTitle: "Meditation & Mental Cultivation",
    ...
    keyPaliTerms: [
      ...
      { term: "Ānāpāna", meaning: "In-and-out breath meditation, the supreme anchor for both calm and insight" },
      { term: "Nīvaraṇa", meaning: "The Five Hindrances: sensual desire, ill-will, sloth/torpor, restlessness, doubt" },
      { term: "Jhāna", meaning: "Meditative absorptions, states of profound unshakeable stillness and joy" }
    ],
    overview: "Bhāvanā literally means 'development' or 'bringing into being'. Rather than being an escape from the world, meditation is mental hygiene and strength training for the householder. Combining Samatha (tranquil focus) and Vipassanā (insight into the nature of reality), the mind becomes an invincible sanctuary amidst the turbulence of modern vocational and domestic responsibilities.",
    canonicalExcerpts: [
      {
        source: "MN 118 — Ānāpānasati Sutta",
        pali: "So satova assasati, satova passasati. Dīghaṁ vā assasanto 'dīghaṁ assasāmī'ti pajānāti...",
        translation: "Breathing in long, he discerns: 'I am breathing in long'; or breathing out long, he discerns: 'I am breathing out long'... Breathing in sensitive to the whole body, he trains himself: 'I will breathe in sensitive to the whole body.'"
      },
      {
    ...
    householdApplication: [
      {
        ...
        detail: "Dedicate 20–30 minutes at dawn before the household awakes. Use the physical breath at the nostrils or upper lip as an unshakeable home base. When thoughts of bills, work deadlines, and projects arise, acknowledge them gently and return to the breath."
      },
      {
        title: "Overcoming the Five Household Hindrances",
        detail: "Sensory greed (craving screen dopamine), ill-will (lingering family grudges), lethargy (mental fog), anxiety/restlessness (overstimulated nervous system), and skeptical doubt. Meet each hindrance not with self-judgment, but with clear recognition: 'A hindrance is present; it is impermanent.'"
      },
      {
        title: "Micro-Meditations During Transit & Work",
        detail: "Use red lights, elevators, kettle boiling, or computer boot-ups as sacred mindfulness bells. Take three conscious, grounded breaths to reset the nervous system before responding to demanding situations."
      }
    ],
    contemplativeInquiry: [
      "Is my daily practice consistent like the steady drop of water, or sporadic and volatile?",
      "Can I observe the stillness underlying worldly sounds right now?"
    ]
  },
  {
    id: "satipatthana",
    ...
    englishTitle: "Foundations of Mindfulness",
    ...
    keyPaliTerms: [
      { term: "Kāyānupassanā", meaning: "Mindful contemplation of the body (breath, postures, elements, sensations)" },
      { term: "Vedanānupassanā", meaning: "Mindful contemplation of feeling tones (pleasant, painful, neutral)" },
      { term: "Cittānupassanā", meaning: "Mindful contemplation of states of mind (lustful, angry, distracted, focused)" },
      { term: "Dhammānupassanā", meaning: "Contemplation of mental phenomena (5 hindrances, 5 aggregates, 7 awakening factors)" },
      { term: "Sampajañña", meaning: "Clear situational comprehension, knowing the purpose and suitability of actions" }
    ],
    overview: "The Buddha declared Satipaṭṭhāna to be the 'ekāyano maggo' — the direct, non-deviating highway for overcoming sorrow and lamentation. It establishes somatic and psychological awareness across four panoramic foundations: Body, Feelings, Mind, and Mental Objects. For the layperson, Satipaṭṭhāna bridges the cushion and the kitchen, transforming chores and meetings into supreme spiritual arenas.",
    canonicalExcerpts: [
      {
    ...
    householdApplication: [
      {
        ...
        detail: "When washing dishes, carrying groceries, or typing on a keyboard, maintain peripheral awareness of physical sensations, foot contact with the earth, and muscle tension in shoulders and jaw."
      },
      {
        title: "Watching Feeling Tones (*Vedanānupassanā*) in Conversations",
        detail: "Notice the instant a conversation turns awkward or flattering. Discern the raw feeling tone (pleasant/unpleasant) before the ego crafts a reactive narrative."
      },
      {
  ...
  },
  {
    ...
    englishTitle: "The Four Sublime Abodes",
    ...
    keyPaliTerms: [
      ...
      { term: "Karuṇā", meaning: "Compassion, the heart's trembling resonance that wishes to relieve suffering" },
    ...
    canonicalExcerpts: [
      ...
      },
      {
        ...
        translation: "He abides radiating in all four directions with a mind imbued with equanimity, abundant, exalted, measureless, free from hostility and affliction."
      }
    ],
    householdApplication: [
      {
        title: "Mettā in Marriage & Parenting",
        detail: "Loving-kindness is wishing well without conditions of reciprocity. Practice silent mettā phrases when conflicts arise: 'May you be peaceful, may you be free from stress, may our home be harmonious.'"
      },
      {
        title: "Muditā as the Antidote to Envy in Modern Society",
        detail: "When peers or colleagues get promoted, buy luxurious homes, or receive praise, modern conditioning breeds envy. Muditā deliberately rejoices: 'How wonderful that they are enjoying happiness! May their joy endure!'"
      },
      {
        title: "Upekkhā Facing the Eight Worldly Winds (*Aṭṭha Lokadhammā*)",
        detail: "Gain and loss, pleasure and pain, praise and blame, fame and disrepute. Equanimity enables the householder to stand like a granite boulder amidst life's storms, knowing all beings inherit the fruits of their own intentional actions."
      }
    ],
    contemplativeInquiry: [
      "Is there someone in my daily life toward whom I hold cold indifference or resentment? Can I extend goodwill toward their suffering?",
      "Can I celebrate someone else's achievement today without silently comparing it to my own?"
    ]
  },
  {
    id: "gihinivaya",
    ...
    englishTitle: "Guidance for Laypeople",
    ...
    keyPaliTerms: [
      { term: "Gihivinaya", meaning: "The Code of Discipline for the Householder" },
      { term: "Pañcasīla", meaning: "The Five Ethical Precepts (harmlessness, honesty, fidelity, truth, sobriety)" },
      { term: "Sammā-ājīva", meaning: "Right Livelihood, ethical trade free from harm, deceit, and exploitation" },
      { term: "Anaṇa-sukha", meaning: "The supreme bliss of freedom from debt and economic liability" },
      { term: "Saddhā / Cāga", meaning: "Confidence in awakening and generous, open-handed sharing" }
    ],
    overview: "The Buddha provided extraordinarily detailed, pragmatic economic and relational advice for lay householders. Often termed the 'Vinaya of the Layperson', texts like the Sigālovāda Sutta map the world into six sacred directions of mutual responsibility, while suttas on wealth outline prudent financial budgeting, honest enterprise, and the profound mental peace of ethical solvency.",
    canonicalExcerpts: [
      {
        source: "DN 31 — The Sigālovāda Sutta (The Six Directions)",
      ...
      {
        source: "AN 8.54 — The Four Conditions for Worldly Success",
    ...
    householdApplication: [
      {
        title: "The Classical Buddhist Budgeting Matrix",
      ...
      },
      {
        ...
        detail: "1. The bliss of rightful acquisition (*Atthi-sukha*); 2. The bliss of sharing wealth with loved ones and charity (*Bhoga-sukha*); 3. The bliss of being free from debt (*Anaṇa-sukha*); 4. The supreme bliss of blameless ethical conduct (*Anavajja-sukha*)."
      },
      {
        title: "Nourishing Wholesome Spiritual Friendship (*Kalyāṇamittatā*)",
  ...
  },
  {
    ...
    englishTitle: "The Path of the Dhamma",
    ...
    keyPaliTerms: [
      { term: "Appamāda", meaning: "Heedfulness, vigilance, non-complacency, diligence in spiritual practice" },
      ...
      { term: "Paṇḍita", meaning: "The wise person, one whose conduct and discernment are refined" },
      { term: "Bāla", meaning: "The spiritually foolish or uncultivated person who follows blind impulse" }
    ],
    overview: "The Dhammapada is the most widely treasured anthology of the Buddha's sayings. Comprising 423 poetic verses organized into 26 chapters (*vaggas*), it delivers crystal-clear moral maxims, psychological insights, and vivid nature parables. For the householder, each verse functions as a portable beacon of clarity for daily dilemmas.",
    canonicalExcerpts: [
      {
    ...
    householdApplication: [
      {
        ...
        detail: "Memorize verse 1 and 2. Every interaction in the home begins with a mental intention. Purify the intention first before speech leaves the mouth."
      },
      {
        title: "Guarding Speech in Heated Moments",
        detail: "Verse 133: 'Do not speak harshly to anyone; those spoken to might answer back. Painful is quarrelsome talk.' Before retaliating in arguments, pause and heed the Dhammapada's counsel on harmless speech."
      },
      {
        title: "The Solitary Drop of Water",
        detail: "Verse 122: 'Do not underestimate wholesome deeds, thinking: They will amount to nothing. Even a water pot is filled drop by drop.' Every small act of patience, kindness, and mindfulness accumulates vast spiritual capital."
      }
    ],
    contemplativeInquiry: [
      "Am I living with heedfulness (*appamāda*) today, or drifting on automatic pilot?",
      "Can I recite a verse of the Dhammapada to anchor my mind when temptation or irritation arises?"
    ]
  },
  {
    id: "jatakani",
    number: "08",
    paliTitle: "Jātakāni",
    englishTitle: "The Birth Stories",
    tagline: "The Bodhisatta's Multi-Lifetime Cultivation of the Ten Perfections in Ordinary Worldly Roles",
    ...
    keyPaliTerms: [
      ...
      { term: "Bodhisatta", meaning: "A being dedicated to the realization of unexcelled Buddhahood" },
      { term: "Dāna-pāramī", meaning: "The perfection of generosity and relinquishment (exemplified in Vessantara)" },
      { term: "Khanti-pāramī", meaning: "The perfection of heroic patience, forbearance, and forgiveness" },
      { term: "Sacca-pāramī", meaning: "The perfection of truthfulness and unwavering integrity" }
    ],
    overview: "The Jātaka tales narrate the previous lives of the Buddha as he perfected the Ten Pāramīs across centuries. Significantly, the vast majority of these lives were spent not as ascetic hermits, but as householders: merchants, artisans, physicians, ministers, parents, and community leaders. They provide an unmatched treasure trove of moral grit, heroic sacrifice, and practical wisdom for family and civic life.",
    canonicalExcerpts: [
      {
        source: "Khantivādī Jātaka (No. 313) — The Heroic Forbearance",
      ...
      {
        source: "Vessantara Jātaka (No. 547) — The Pinnacle of Relinquishment",
        pali: "Dānaṁ daddallamānaṁva, cāgena anapekkhavā...",
        translation: "Giving shining brightly, giving without backward longing, without expectation of reward, for the liberation of the heart."
      }
    ],
    householdApplication: [
      {
        title: "Perfections in the Modern Workplace",
        detail: "See your profession not as a secular trap, but as the Bodhisatta's training ground for Pāramī: practicing Viriya (energy) in work ethic, Sīla (virtue) in accounting, and Sacca (truth) in contractual commitments."
      },
      {
        title: "Heroic Forbearance (*Khanti*) in Difficult Relationships",
        detail: "Like the Bodhisatta in the Khantivādī story, when subjected to unfair criticism or organizational malice, refuse to generate hatred. Let forbearance be your armor."
      },
      {
        title: "Moral Storytelling for Family Culture",
        detail: "Use the Jātaka stories to teach children and younger generations timeless values of gratitude, animal welfare, environmental reverence, and courage."
      }
    ],
    contemplativeInquiry: [
      "Which of the Ten Perfections (Generosity, Virtue, Renunciation, Wisdom, Energy, Patience, Truth, Resolve, Loving-kindness, Equanimity) is most challenged in my life today?",
      "Can I treat today's frustrating domestic tasks as my Bodhisatta training?"
    ]
  },
  {
    id: "lokadhatu",
    number: "09",
    paliTitle: "Lokadhātu",
    englishTitle: "Buddhist Cosmology",
    ...
    keyPaliTerms: [
      { term: "Tiloka", meaning: "The Three Realms: Kāmadhātu (Sensory), Rūpadhātu (Form), Arūpadhātu (Formless)" },
      { term: "Saṁsāra", meaning: "The beginningless round of rebirth, driven by craving and volitional kamma" },
      { term: "Manussa-lābha", meaning: "The rare, precious opportunity of human rebirth equipped with Dhamma" },
      { term: "Kamma-vipāka", meaning: "The infallible maturation of intentional actions across lifetimes" },
      { term: "Sakkāyadiṭṭhi", meaning: "The delusion of a permanent, isolated self within the cosmos" }
    ],
    overview: "Buddhist cosmology is not merely astronomical folklore; it is an existential psychological map. Across 31 distinct realms spanning heavens, human planes, ghost realms, animal worlds, and hells, the Buddha revealed that every state of being is a direct manifestation of consciousness and moral action. For householders, this macro-perspective imbues human life with infinite urgency and dignity.",
    canonicalExcerpts: [
      {
        ...
        translation: "Suppose a man threw into the ocean a yoke with a single hole, and a blind sea turtle surfaced only once every hundred years. More difficult and rare than that turtle putting its neck through that single yoke is obtaining human birth with the opportunity to hear the True Dhamma."
      },
      {
    ...
    householdApplication: [
      {
        ...
        detail: "Even lifetimes as celestial monarchs in the Brahma realms end when the merit is exhausted. Understanding the impermanence of all cosmic status frees the householder from desperate status anxiety and social climbing."
      },
      {
        title: "The Sacred Opportunity of Human Birth (*Manussa-lābha*)",
        detail: "Human life combines enough suffering to breed disillusionment (*saṁvega*) and enough mental clarity to practice wisdom. Do not squander this priceless human embodiment on trivial distractions."
      },
      {
        title: "The Five Daily Remembrances (*Upajjhatthana*)",
        detail: "Recite daily: I am subject to aging; I am subject to illness; I am subject to death; all that is dear will change and separate from me; my only true estate is my intentional actions (*kamma*)."
      }
    ],
    contemplativeInquiry: [
      "If I truly absorb the rarity of human life, how would I re-prioritize how I spend my evening hours?",
      "Can I view today's decisions through the lens of karmic seeds that outlive this temporary body?"
    ]
  }
];
const DHAMMAPADA_DAILY_VERSES = [
  {
    verse: 1,
    pali: "Manopubbaṅgamā dhammā manosseṭṭhā manomayā.",
    english: "Mind precedes all mental states; mind is their chief, they are mind-made.",
    theme: "Mastery of Intention"
  },
  {
    verse: 5,
    ...
    theme: "Reconciliation & Peace"
  },
  {
    verse: 21,
    pali: "Appamādo amatapadaṁ, pamādo maccuno padaṁ.",
    english: "Heedfulness is the path to the Deathless; heedlessness is the path to death.",
    theme: "Spiritual Vigilance"
  },
  {
    verse: 103,
    pali: "Yo sahassaṁ sahassena saṅgāme mānuse jine, Ekañca jeyyamattānaṁ sa ve saṅgāmajuttamo.",
    english: "Though one may conquer a thousand times a thousand men in battle, yet he who conquers himself is the supreme conqueror.",
    theme: "Self-Conquest"
  },
  {
    verse: 122,
    pali: "Māvamaññetha puññassa 'na mantaṁ āgamissati'; Udabindunipātena udakumbhopi pūrati.",
    english: "Do not underestimate merit, thinking: 'It will not come to me.' Drop by drop is the water pitcher filled.",
    theme: "Incremental Goodness"
  },
  {
    verse: 204,
    pali: "Ārogyaparamā lābhā santuṭṭhiparamaṁ dhanaṁ; Vissāsaparamā ñātī nibbānaṁ paramaṁ sukhaṁ.",
    english: "Health is the supreme acquisition; contentment is the greatest wealth; trust is the closest kinship; Nibbāna is the ultimate bliss.",
    theme: "True Wealth"
  }
];
